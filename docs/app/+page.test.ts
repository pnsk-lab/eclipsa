...
const TestLandingPage = __eclipsaComponent(
  () =>
    /* @__PURE__ */ jsxDEV(LandingPage, {}, void 0, false, {
      fileName: 'docs/app/+page.test.ts',
      lineNumber: 21,
      columnNumber: 9,
    }),
  'landing-page-test',
...
describe('landing page', () => {
  ...
  it('resolves per-section progress from measured ranges', () => {
    expect(resolveSectionProgress(void 0, 120)).toBe(0)
  ...
  it('renders the landing sections without scroll reveal wrappers or hidden initial styles', () => {
    const result = renderSSR(
      () =>
        /* @__PURE__ */ jsxDEV(TestLandingPage, {}, void 0, false, {
          fileName: 'docs/app/+page.test.ts',
          lineNumber: 147,
          columnNumber: 36,
        }),
